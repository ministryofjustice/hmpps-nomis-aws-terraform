...
output "ami_nomis_db_2" {
  value = "${module.nomis_db_2.ami_id}"
}

output "public_fqdn_nomis_db_2" {
  value = "${module.nomis_db_2.public_fqdn}"
}

output "internal_fqdn_nomis_db_2" {
  value = "${module.nomis_db_2.internal_fqdn}"
}

output "private_ip_nomis_db_2" {
  value = "${module.nomis_db_2.private_ip}"
}

output "db_disks_nomis_db_2" {
  value = "${module.nomis_db_2.db_size_parameters}"
}

# map (tidier)
output "nomis_db_2" {
  value = {
    ami_id        = "${module.nomis_db_2.ami_id}",
    public_fqdn   = "${module.nomis_db_2.public_fqdn}",
    internal_fqdn = "${module.nomis_db_2.internal_fqdn}",
    private_ip    = "${module.nomis_db_2.private_ip}",
    db_disks      = "${module.nomis_db_2.db_size_parameters}",
    nomis_db_2   = "ssh ${module.nomis_db_2.public_fqdn}",
  }
}
