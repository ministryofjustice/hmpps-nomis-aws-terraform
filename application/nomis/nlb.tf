module "external_nlb" {
  ...
  eip_allocation_ids   = [
    "${data.terraform_remote_state.persistent-eip.nomis_nomis_az1_lb_eip.allocation_id}",
    "${data.terraform_remote_state.persistent-eip.nomis_nomis_az2_lb_eip.allocation_id}",
    "${data.terraform_remote_state.persistent-eip.nomis_nomis_az3_lb_eip.allocation_id}"
  ]
  ...
  alb_fqdn                     = "${module.nomis.private_fqdn_internal_alb}"
  haproxy_instance_type        = "${var.nomis_haproxy_instance_type}"
  haproxy_instance_count       = "${var.nomis_haproxy_instance_count}"
}